$(function() {
	...
	var pageSize = 10;
	// 获取店铺列表的URL
	var listUrl = '/webshop/frontend/listshops';
	// 获取店铺类别列表以及区域列表的URL
	var searchDivUrl = '/webshop/frontend/listshopspageinfo';
	// 页码
	var pageNum = 1;
	...
	function addItems(pageSize, pageIndex) {
		// 拼接出查询的URL,赋空值默认就去掉这个条件限制,有值就代表按这个条件去查询
								...
								data.shopList
										.map(function(item, index) {
											html += ''
													...
													+ item.shopName
													+ '</div><div class="card-content"><div class="list-block media-list"><ul><li class="item-content"><div class="item-media"><img src="'
													+ item.shopImg
	...
	$('.shop-list').on('click', '.card', function(e) {
		...
		window.location.href = '/webshop/frontend/shopdetail?shopId=' + shopId;
	});
