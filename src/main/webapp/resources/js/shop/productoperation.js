$(function(){
	...
	var infoUrl = '/webshop/shopadmin/getproductbyid?productId='+productId;
	//获取当前店铺设定的商品类别列表的URL
	var categoryUrl = '/webshop/shopadmin/getproductcategorylist';
	//更新商品信息的URL
	var productPostUrl = '/webshop/shopadmin/modifyproduct';
	...
	if(productId){
		...
		getCategory();
		productPostUrl = '/webshop/shopadmin/addproduct';
	}
	...
	//针对商品详情图控件组,若该控件组的最后一个元素发生变化(即上传了图片),且控件总数据未达到6个,则生成新的一个文件上传控件
